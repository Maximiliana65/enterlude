...
- 非対応: ChromeのGeminiサイドパネル、Microsoft EdgeのCopilotなど、ブラウザに組み込まれたAI画面
...
- Chrome更新とEdge初回申請には、動作確認済みの同じ固定ZIPだけを使用する
